<header class="navbar navbar-expand-md d-print-none">
  <div class="container-xl">
    ...
    <div class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-md-3 pe-0">
      <a href="." aria-label="Tabler"><svg class="navbar-brand-image" xmlns="http://www.w3.org/2000/svg" width="110" height="32" viewBox="0 0 232 68">
          <path style="fill: var(--tblr-primary, #066fd1)"
    ...
    <div class="navbar-nav order-md-last flex-row">
      <div class="nav-item d-none d-md-flex me-3">
        <div class="btn-list">
          <a class="btn btn-5" href="https://github.com/tabler/tabler" target="_blank" rel="noreferrer">
          ...
          <a class="btn btn-6" href="https://github.com/sponsors/codecalm" target="_blank" rel="noreferrer">
            <!-- Download SVG icon from http://tabler.io/icons/icon/heart -->
            <svg class="icon text-pink icon-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
      ...
      <div class="d-none d-md-flex">
        <div class="nav-item">
          <a class="nav-link hide-theme-dark px-0" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Enable dark mode" href="?theme=dark"
            ...
            <svg class="icon icon-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
              stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="nav-item dropdown d-none d-md-flex">
          <a class="nav-link px-0" data-bs-toggle="dropdown" data-bs-auto-close="outside" href="#" aria-label="Show notifications" aria-expanded="false" tabindex="-1">
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                      <a class="list-group-item-actions" href="#">
                        ...
                        <svg class="icon text-muted icon-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                      <a class="list-group-item-actions show" href="#">
                        <!-- Download SVG icon from http://tabler.io/icons/icon/star -->
                        <svg class="icon text-yellow icon-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                          <path d="M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z"></path>
                        </svg>
                      </a>
        ...
        <div class="nav-item dropdown d-none d-md-flex me-3">
          <a class="nav-link px-0" data-bs-toggle="dropdown" data-bs-auto-close="outside" href="#" aria-label="Show app menu" aria-expanded="false" tabindex="-1">
            <!-- Download SVG icon from http://tabler.io/icons/icon/apps -->
            <svg class="icon icon-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
            <div class="card">
              ...
              <div class="card-body scroll-y p-2" style="max-height: 50vh">
                <div class="row g-0">
                  <div class="col-4">
                    <a class="d-flex flex-column flex-center text-secondary link-hoverable px-2 py-2 text-center" href="#">
                      <img class="mx-auto mb-2 h-6 w-6" src="./static/brands/amazon.svg" alt="" width="24" height="24">
      ...
      <div class="nav-item dropdown">
        <a class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown" href="#" aria-label="Open user menu">
          <div class="d-none d-xl-block pe-2">
            <div>Lotrando</div>
            <div class="small text-secondary mt-1">Laravel Developer</div>
          </div>
          <span class="avatar avatar-sm" style="background-image: url(./static/avatars/lotrando.jpg)"></span>
        </a>
